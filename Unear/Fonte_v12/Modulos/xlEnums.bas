...
'---------------------------------------------------------------------------------------
' Módulo....: Publicas / Módulo
' Conteúdo....: Enums
' Autor.....: Fernando Fernandes (com ajuda do Adeslon)
' Contato...: fernando@tecnun.com.br
' Data......: 31/03/2015
' Empresa...: Tecnun Tecnologia em Informática
' Descrição.: Este módulo visa facilitar todo desenvolvimento quando entramos no Excel via Object.
'             Todas estas Enums foram geradas pelo código comentado ao final delas, diretamente no Excel.
'---------------------------------------------------------------------------------------
...
' DESCRIÇÃO        : Gera um modulo relacionando todos os membros (modulos, classes, enums) de uma biblioteca de objetos em forma de Enum
'---------------------------------------------------------------------------------------
'
...
5   strCode = "Attribute VB_Name = ""mLib_" & VBA.UCase(tliTypeLibInfo.Name) & """" & VBA.vbNewLine
    ...
    strCode = strCode & "'Objetivo      : Comtem um enumerados com todos os membros (enums, funções, propriedades) encontrados na bilioteca abaixo identificada." & vbNewLine
    ...
    If pDescricao <> "" Then
        strCode = strCode & "'" & VBA.Space(3) & "Descrição                 : " & pDescricao & vbNewLine
    End If
